...
if [ -z "$port_443" ];
	then
		...
		dirb https://$TARGET:443/ $DIRB_DIR -w 		
	fi
...
if [ -z "$port_8080" ];
	then
		...
		dirb http://$TARGET:8080/ $DIRB_DIR -w 
	fi
